...
public interface ToolSettingsStore {
     ...
     */
    Set<String> getEnabledToolNames(Collection<BaseTool> implementedTools);
     ...
     * 构造工具提示（按已注册工具过滤）。
     */
    String buildToolPrompt(Collection<BaseTool> implementedTools, boolean nativeToolProtocol);
}
